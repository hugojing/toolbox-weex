...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/977957bd083432b9d1f8d3d733541e91", [], function(__weex_require__, __weex_exports__, __weex_module__){
	  ...
	  __weex_module__.exports = {
	    ...
	    methods: {
	      ...
	      translate: function(e) {
	        ...
	        var GET_URL = 'http://fanyi.youdao.com/openapi.do?keyfrom=min-toolbox&key=1267180728&type=data&doctype=json&version=1.1&q=' + self.txtInput
	        stream.fetch({
	          method: 'GET',
	          url: GET_URL,
	          type: 'json'
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        "type": "text",
	        "placeholder": "请输入……",
	        "value": function () {return this.txtInput}
	      },
	      "events": {
	        "input": "oninput"
	      }
	    ...
	    },
	    {
	      ...
	      "repeat": {
	        "expression": function () {return this.txtOutput.translation},
	        "value": "word"
	      },
	      "attr": {
	...
	;__weex_bootstrap__("@weex-component/977957bd083432b9d1f8d3d733541e91", {
